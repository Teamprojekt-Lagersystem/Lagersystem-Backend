...
interface StoredProductRepository {
    fun createStoredProduct(productId: String, spaceId: String, quantity: Double): StoredProduct
    ...
    fun updateStoredProduct(id: String, spaceId: String?, quantity: Double?): StoredProduct?
