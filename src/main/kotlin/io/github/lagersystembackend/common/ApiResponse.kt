...
object ErrorMessages {
    ...
    val INVALID_UUID_STORED_PRODUCT = ApiError("INVALID_UUID" , "The provided stored product ID is not a valid UUID.")
    ...
    val BODY_NOT_SERIALIZED_STORED_PRODUCT = ApiError("BODY_NOT_SERIALIZED" , "The request of specified stored product is not in the expected format.")
